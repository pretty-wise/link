...
WatchManager::WatchManager() { m_mutex.Initialize(); }

WatchManager::~WatchManager() { m_mutex.Terminate(); }

WatchHandle WatchManager::Create(const char *name, const char *version,
                                 const char *hostname) {
...
void WatchManager::Filter(const char *plugin_name, const char *plugin_version,
                          const char *plugin_hostname,
