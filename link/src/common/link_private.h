...
typedef int (*GetNotificationPtr)(void* context, struct Notification* notif, int timeout_ms);
typedef WatchHandle (*CreatePluginWatchPtr)(void* context, const char* name_filter, const char* version_filter, const char* hostname_filter);
typedef ConnectionHandle (*ConnectPtr)(void* context, PluginHandle handle);
typedef int (*SendPtr)(void* context, ConnectionHandle connection, const void* bytes, streamsize count);
typedef int (*GetInfoPtr)(void* context, PluginHandle handle, struct PluginInfo* info);
typedef void (*LogWritePtr)(void* context, const char* file, int line, int category, const char* format, va_list args);
typedef unsigned int (*GetTotalRecvAvailablePtr)(void* context, ConnectionHandle conn);
typedef unsigned int (*GetRecvAvailablePtr)(void* context, ConnectionHandle conn);
typedef int (*RecvPtr)(void* context, ConnectionHandle handle, void* buffer, unsigned int nbytes);
...
typedef PluginHandle (*RegisterPluginPtr)(void* context, struct PluginInfo* info);
